...
int main()
{
    ...
    auto durationTraditional = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
    ...
    std::cout << "Traditional Lexer tokens: " << tokensTraditional.size() << " time: " << durationTraditional
              << " us\n";
    std::cout << "Multithread Lexer tokens: " << tokensMulti.size() << " time: " << durationMulti << " us\n";
